...
def cargar_chunks_manual(role,school:str="ALL"):
    docs = []

    # Chunk 1: Requisitos curriculares
    docs.append(Document(
        page_content=(
            "Para poder realizar prácticas curriculares en la Universitat Politècnica de València (UPV), "
            ...
            "Es un requisito indispensable para poder realizar prácticas curriculares en la UPV."
        ),
    ...
    docs.append(Document(
        page_content=(
            "En los dobles grados no se pueden realizar prácticas curriculares debido a que estas titulaciones no contemplan asignaturas optativas en su plan de estudios. "
            "Sin embargo, sí es posible realizar prácticas extracurriculares dependiendo de que doble grado  "
    ...
    docs.append(Document(
        page_content=(
            ...
            "a la Unidad de Prácticas en Empresa, preferiblemente en un plazo de 7 días naturales desde la causa de la rescisión. "
    ...
    docs.append(Document(
        page_content=(
            ...
            "No obstante, se recomienda una dedicación de 20 horas semanales durante el periodo lectivo "
    ...
    docs.append(Document(
        page_content=(
            "Las prácticas curriculares son en la mayor parte optativas (aunque en algunos casos pueden ser obligatorias) y forman parte del plan de estudios oficial y, por tanto, computan créditos ECTS. "
    ...
    docs.append(Document(
        page_content=(
            "Prácticas en verano: En la Universitat Politècnica de València (UPV), se permite realizar prácticas externas durante el verano, siempre que el estudiante no se haya titulado antes. "
    ...
    docs.append(Document(
        page_content=(
            "Compatibilidad con el TFG y final de titulación: En la Universitat Politècnica de València (UPV), "
